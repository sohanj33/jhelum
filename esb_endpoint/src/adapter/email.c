...
#define FROM "rockyrohan890@gmail.com"
#define TO "rockyrohan890@gmail.com"
#define CC "rockyrohan890@gmail.com"
...
int send_mail(char * to, char * file_path) {
    ...
    if (curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_PASSWORD, "rockyrohan890@8123");
